({
  steps: {
    stars: {
      ...
      `,
      active: { selector: '#gamePlane [code="Deck[card_zone_client]"] .card-event', customClass: 'tutorial-stars' },
    ...
    color: {
      ...
      `,
      active: { selector: '#gamePlane [code="Deck[card_zone_client]"] .card-event', customClass: 'tutorial-color' },
    ...
    budget: {
      ...
      `,
      active: { selector: '#gamePlane [code="Deck[card_zone_client]"] .card-event', customClass: 'tutorial-budget' },
