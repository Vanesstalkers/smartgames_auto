(function () {
  ...
  switch (this.roundStep) {
    case 'ROUND_START': {
      ...
      return { ...result, timerRestart: true };
    }
    ...
    case 'REPLACE_CLIENT': {
      ...
      this.activatePlayers({ notifyUser: 'Клиент поменялся, ты можешь сделать новое предложение.' });
    ...
    case 'FIRST_OFFER': {
      ...
      if (!player) {
        ...
        return { ...result, timerRestart: false, forcedEndRound: true };
      }
