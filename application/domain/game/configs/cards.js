() => [
  ...
  {
    group: 'car',
    name: 'lada_vesta_cross_sw',
    title: 'Lada Vesta Cross SW',
    stars: 1,
    price: 1900,
    priceGroup: ['family'],
    equip: ['tires'],
  ...
  {
    group: 'car',
    name: 'faw_bestune_t77',
    title: 'FAW Bestune T77',
    stars: 2,
    price: 2500,
    priceGroup: ['family'],
    equip: ['leather', 'climat'],
  },
  {
    group: 'car',
    name: 'moskvich_6',
  ...
  },
  {
    ...
    price: 4700,
    priceGroup: ['family'],
    equip: ['gearbox', 'leather', 'climat', 'massage'],
  },
  {
    group: 'car',
    name: 'skywell_et5',
  ...
  },
  {
    ...
    price: 5500,
    priceGroup: ['vip'],
    equip: ['wheels', 'gearbox', 'leather', 'climat'],
  },
  {
    group: 'car',
    name: 'byd_han',
  ...
  },
  {
    ...
    price: 6500,
    priceGroup: ['vip'],
    equip: ['massage', 'gearbox', 'leather', 'climat'],
  },
  {
    group: 'car',
    name: 'hongqi_h9',
    ...
    price: 7000,
    priceGroup: ['vip'],
    equip: ['massage', 'wheels', 'gearbox', 'leather', 'climat'],
  },
  {
    group: 'car',
    name: 'zeekr_001',
  ...
  { group: 'service', name: 'sport', title: 'Спортивные обвесы', price: '+10%', priceGroup: ['cheap'] },
  { group: 'service', name: 'massage', title: 'Сиденья с функцией массажа', price: '+400', stars: 1, equip: ['massage'] },
  { group: 'service', name: 'massage', title: 'Сиденья с функцией массажа', price: '+400', stars: 1, equip: ['massage'] },
  {
    group: 'service',
    name: 'climat',
  ...
  { group: 'client', name: 'newlyweds1', title: 'Молодожены', money: 1200, stars: 1, priceGroup: ['cheap', 'family'] },
  { group: 'client', name: 'newlyweds2', title: 'Молодожены', money: 1350, stars: 2, priceGroup: ['cheap', 'family'] },
  ...
  { group: 'client', name: 'outdoors', title: 'Любители отдыха', money: 1050, stars: 1, priceGroup: ['cheap', 'suv'] },
  ...
  { group: 'client', name: 'businesswoman', title: 'Бизнес-леди', money: 3000, stars: 4, priceGroup: ['vip', 'woman'] },
  { group: 'client', name: 'summer', title: 'Дачница', money: 1200, stars: 2, priceGroup: ['suv', 'woman'] },
  { group: 'client', name: 'housewife', title: 'Домохозяйка', money: 1050, stars: 2, priceGroup: ['family', 'woman'] },
